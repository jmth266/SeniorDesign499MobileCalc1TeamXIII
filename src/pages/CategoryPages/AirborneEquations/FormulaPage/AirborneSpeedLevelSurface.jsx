...
function AirborneSpeedLevelSurface() {
    ...
    return (
        <div className={"container mb-5 center"}>
            <Formula
                formulaName={"Airborne Speed off of Level Surface"}
                numericFields={
                ...
                onCalculate={() => {
                    ...
                    const calculatedGrade = 2.73 * hDistance / Math.sqrt(vDistance);
...
export default AirborneSpeedLevelSurface;
