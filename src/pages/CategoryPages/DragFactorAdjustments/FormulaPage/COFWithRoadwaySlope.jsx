...
function COFWithRoadwaySlope() {
    ...
    return (
        <div className={"container mb-5 center"}>
            <Formula
                formulaName={"Level of Coefficient of Friction by a Percentage of Braking and Roadway Slope"}
                numericFields={
                ...
                onCalculate={() => {
                    ...
                    const calculatedGrade = (COF * braking * Math.cos(rSlope/180)) + Math.sin(rSlope/180);
...
export default COFWithRoadwaySlope;